...
provider.addScope('https://www.googleapis.com/auth/plus.login');
    ...
    var startAuthServerRegister = function() { // check state of user auth; otherwise send to log in to begin
    ...
    var startAuthListenerLogIn = function() { // if user signed in and in firebase, go to main, if no got to register/signup
        firebase.auth().onAuthStateChanged(function(user) {
            if (user) {
